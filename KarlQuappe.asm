; FIXED 21.09.2020
;Level 9 on cranky vectrex does not work
;snake levels frog "jumps" from lane to lane ...


; changes on 2. April 2019 
; - Fly vectorlist  three positions, to accomodate cranky vectrex
; adjustment for cranky vectrex in demo mode (4 NOP)
; bug fix - car dwath in demo mode, box was not centered (my own wait recal did not Zero!)
...
;                    STD      <VIA_port_b 
                    STa      <VIA_port_b 
                    STb      <VIA_port_a 
 nop 4 ; only cranky Vectrex and only in demo mode!
